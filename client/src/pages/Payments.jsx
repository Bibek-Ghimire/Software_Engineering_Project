                    ...
                    <motion.button
                      ...
                      className={`p-3 rounded-lg border-2 transition-all text-center ${
                        selectedPaymentMethod === method.id
                          ? `border-orange-500 bg-stone-100 dark:bg-orange-950/50`
                          : "border-stone-300 dark:border-stone-700 hover:border-orange-400 dark:hover:border-orange-500"
                      }`}
                    >
                ...
                {selectedPaymentMethod === "esewa" && (
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setEsewaPhoneEmail(e.target.value)}
                ...
                {selectedPaymentMethod === "khalti" && (
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setKhaltiPhoneEmail(e.target.value)}
