      ...
      <div className="flex min-h-screen page-surface">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <div className="w-10 h-10 rounded-full border-2 border-stone-200 dark:border-stone-700 border-t-orange-500 animate-spin mx-auto mb-5" />
                    ...
                    <div className="p-6 flex-grow flex flex-col">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 mt-auto">
                        ...
                        <button
                          ...
                          className="flex-1 secondary-action py-3 gap-2"
                        >
