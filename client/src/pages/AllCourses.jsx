...
import { BookOpen, CalendarCheck, Sun, Moon, GraduationCap, Clock, BarChart3, User, Star, TrendingUp, Award, Filter } from "lucide-react";
...
const AllCourses = () => {
  ...
  const getLevelStyling = (level) => {
    ...
    if (levelLower === 'beginner') return {
      bg: 'from-emerald-400 to-green-500',
      text: 'text-white',
      icon: '🌱',
      shadow: 'shadow-emerald-300/50'
    };
    if (levelLower === 'intermediate') return {
      bg: 'from-amber-400 to-orange-500',
      text: 'text-white',
      icon: '⚡',
      shadow: 'shadow-amber-300/50'
    };
    if (levelLower === 'advanced') return {
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-blue-200/50 dark:border-gray-600/50">
              <p className="text-blue-600 dark:text-blue-400 font-semibold text-lg">Loading amazing courses...</p>
              <p className="text-blue-500/70 dark:text-blue-400/70 text-sm mt-2">Preparing your learning journey</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl p-12 border border-red-200/50 dark:border-red-800/50 max-w-md">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-red-700 dark:text-red-400 mb-3">Oops! Something went wrong</h3>
      ...
      <div className="flex-1 p-8 relative overflow-auto">
        ...
        <div className="mb-12 text-center lg:text-left">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-6 mb-8">
            <div className="relative">
              <div className="p-6 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 rounded-3xl shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto lg:mx-0">
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/40 dark:border-gray-600/40 shadow-lg">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-bold text-blue-800 dark:text-blue-300">Expert-Led</h3>
              </div>
              <p className="text-blue-600/70 dark:text-blue-400/70 text-sm">Learn from industry professionals</p>
            </div>
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/40 dark:border-gray-600/40 shadow-lg">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/50 dark:to-blue-800/50 rounded-xl">
                ...
                <h3 className="font-bold text-blue-800 dark:text-blue-300">Certified</h3>
              </div>
              <p className="text-blue-600/70 dark:text-blue-400/70 text-sm">Earn recognized certificates</p>
            </div>
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/40 dark:border-gray-600/40 shadow-lg">
              <div className="flex items-center gap-3 mb-2">
                <div className="p-2 bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/50 dark:to-blue-800/50 rounded-xl">
                ...
                <h3 className="font-bold text-blue-800 dark:text-blue-300">Flexible</h3>
              </div>
              <p className="text-blue-600/70 dark:text-blue-400/70 text-sm">Learn at your own pace</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col items-center justify-center py-20">
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl p-16 border border-blue-200/50 dark:border-gray-600/50 text-center max-w-2xl">
              ...
              <p className="text-blue-600/70 dark:text-blue-400/70 text-lg leading-relaxed">
                We're curating exceptional learning experiences just for you. Check back soon for exciting new courses!
              </p>
            </div>
          </div>
        ) : (
            ...
            <div className="mb-12">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-xl border border-blue-200/50 dark:border-gray-600/50 p-8">
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-blue-800 dark:text-blue-300 mb-2">Course Overview</h2>
                  <p className="text-blue-600/70 dark:text-blue-400/70">Your learning journey at a glance</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center group">
                    ...
                    <div className="text-xl font-bold text-blue-700 dark:text-blue-300">Total Courses</div>
                    <div className="text-blue-600/70 dark:text-blue-400/70 text-sm">Available to explore</div>
                  </div>
                  ...
                  <div className="text-center group">
                    <div className="relative mb-4">
                      <div className="w-20 h-20 bg-gradient-to-br from-indigo-400 to-purple-600 rounded-2xl shadow-xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                        <span className="text-3xl font-black text-white">{new Set(courses.map(course => course.level)).size}</span>
                      </div>
                      <div className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                        <BarChart3 className="w-3 h-3 text-white" />
                      </div>
                    </div>
                    <div className="text-xl font-bold text-blue-700 dark:text-blue-300">Skill Levels</div>
                    <div className="text-blue-600/70 dark:text-blue-400/70 text-sm">From beginner to expert</div>
                  </div>
                  ...
                  <div className="text-center group">
                    <div className="relative mb-4">
                      <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-600 rounded-2xl shadow-xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                        <span className="text-3xl font-black text-white">{new Set(courses.map(course => course.teacher?.name).filter(Boolean)).size}</span>
                      </div>
                    ...
                    <div className="text-xl font-bold text-blue-700 dark:text-blue-300">Expert Instructors</div>
                    <div className="text-blue-600/70 dark:text-blue-400/70 text-sm">Ready to guide you</div>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="relative p-6 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-purple-500/10 dark:from-blue-600/20 dark:via-indigo-600/20 dark:to-purple-600/20 border-b border-blue-200/30 dark:border-gray-600/30">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <div className={`inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r ${levelInfo.bg} rounded-full ${levelInfo.shadow} shadow-lg`}>
                    ...
                    <div className="p-6 flex-grow flex flex-col">
                      ...
                      <div className="space-y-4 mb-6">
                        <div className="flex items-center gap-4 p-3 bg-blue-50/50 dark:bg-blue-900/20 rounded-xl border border-blue-100/50 dark:border-blue-800/30">
                          ...
                          <div>
                            <span className="font-semibold text-blue-800 dark:text-blue-300 text-sm">Duration</span>
                            <p className="text-gray-600 dark:text-gray-400 text-sm">{course.duration}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 p-3 bg-blue-50/50 dark:bg-blue-900/20 rounded-xl border border-blue-100/50 dark:border-blue-800/30">
                          ...
                          <div>
                            <span className="font-semibold text-blue-800 dark:text-blue-300 text-sm">Instructor</span>
                            <p className="text-gray-600 dark:text-gray-400 text-sm">{course.teacher?.name || "Expert Instructor"}</p>
                          </div>
                        </div>
                      </div>
        ...
        <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-20 left-20 w-52 h-52 bg-gradient-to-r from-purple-200/20 to-pink-300/20 dark:from-purple-700/10 dark:to-pink-600/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-1/2 right-1/3 w-32 h-32 bg-gradient-to-r from-indigo-200/20 to-blue-300/20 dark:from-indigo-600/10 dark:to-blue-500/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/4 left-3/4 w-36 h-36 bg-gradient-to-r from-cyan-200/20 to-blue-300/20 dark:from-cyan-600/10 dark:to-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
          
          {/* Floating particles */}
          <div className="absolute top-1/3 left-1/4 w-2 h-2 bg-blue-400/40 dark:bg-blue-300/30 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
          <div className="absolute top-2/3 right-1/4 w-3 h-3 bg-indigo-400/40 dark:bg-indigo-300/30 rounded-full animate-bounce" style={{ animationDelay: '1.5s' }}></div>
          <div className="absolute bottom-1/3 left-1/3 w-2 h-2 bg-purple-400/40 dark:bg-purple-300/30 rounded-full animate-bounce" style={{ animationDelay: '2.5s' }}></div>
        </div>
