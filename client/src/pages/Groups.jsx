...
import { Users, Sun, Moon, UserPlus, BookOpen, Crown, MessageCircle, Sparkles, PlusCircle, TrendingUp } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20 transition-all duration-500">
      ...
      <div className="flex-1 p-8 relative overflow-auto">
        ...
        <div className="mb-12 text-center lg:text-left">
          <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-6 mb-8">
            <div className="relative">
              <div className="p-6 bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 rounded-3xl shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto lg:mx-0">
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/40 dark:border-gray-600/40 shadow-lg group hover:scale-105 transition-all duration-300">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-blue-100 to-indigo-200 dark:from-blue-900/50 dark:to-indigo-800/50 rounded-xl group-hover:rotate-12 transition-transform duration-300">
                  <MessageCircle className="w-6 h-6 text-blue-600 dark:text-blue-400" />
                </div>
                <h3 className="font-bold text-blue-800 dark:text-blue-300 text-lg">Collaborate</h3>
              </div>
              <p className="text-blue-600/70 dark:text-blue-400/70 text-sm">Share knowledge and learn from peers</p>
            </div>
            
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/40 dark:border-gray-600/40 shadow-lg group hover:scale-105 transition-all duration-300">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-emerald-100 to-green-200 dark:from-emerald-900/50 dark:to-green-800/50 rounded-xl group-hover:rotate-12 transition-transform duration-300">
                  <TrendingUp className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                </div>
                <h3 className="font-bold text-blue-800 dark:text-blue-300 text-lg">Progress Together</h3>
              </div>
              <p className="text-blue-600/70 dark:text-blue-400/70 text-sm">Track progress and motivate each other</p>
            </div>
            
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-200/40 dark:border-gray-600/40 shadow-lg group hover:scale-105 transition-all duration-300">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 bg-gradient-to-r from-purple-100 to-pink-200 dark:from-purple-900/50 dark:to-pink-800/50 rounded-xl group-hover:rotate-12 transition-transform duration-300">
                  <Crown className="w-6 h-6 text-purple-600 dark:text-purple-400" />
                </div>
                <h3 className="font-bold text-blue-800 dark:text-blue-300 text-lg">Expert Support</h3>
              </div>
              <p className="text-blue-600/70 dark:text-blue-400/70 text-sm">Get guidance from experienced mentors</p>
            </div>
          </div>
        </div>
        ...
        {groups.length > 0 && (
          <div className="mb-12 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-xl border border-blue-200/50 dark:border-gray-600/50 p-8">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-blue-800 dark:text-blue-300 mb-2">Community Overview</h2>
              <p className="text-blue-600/70 dark:text-blue-400/70">Join our thriving learning community</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center group">
                ...
                <div className="text-xl font-bold text-blue-700 dark:text-blue-300">Active Groups</div>
                <div className="text-blue-600/70 dark:text-blue-400/70 text-sm">Ready to join</div>
              </div>
              ...
              <div className="text-center group">
                <div className="relative mb-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-indigo-400 to-purple-600 rounded-2xl shadow-xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                    <span className="text-3xl font-black text-white">{groups.reduce((sum, group) => sum + (group.memberCount || 0), 0)}</span>
                  </div>
                  <div className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center">
                    <UserPlus className="w-3 h-3 text-white" />
                  </div>
                </div>
                <div className="text-xl font-bold text-blue-700 dark:text-blue-300">Total Members</div>
                <div className="text-blue-600/70 dark:text-blue-400/70 text-sm">Learning together</div>
              </div>
              ...
              <div className="text-center group">
                <div className="relative mb-4">
                  <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-teal-600 rounded-2xl shadow-xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                    <span className="text-3xl font-black text-white">{new Set(groups.map(group => group.courseDetail).filter(Boolean)).size}</span>
                  </div>
                ...
                <div className="text-xl font-bold text-blue-700 dark:text-blue-300">Study Topics</div>
                <div className="text-blue-600/70 dark:text-blue-400/70 text-sm">Diverse subjects</div>
              </div>
            </div>
          </div>
        )}
        ...
        {groups.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-3xl shadow-2xl p-16 border border-blue-200/50 dark:border-gray-600/50 text-center max-w-2xl">
              ...
              <p className="text-blue-600/70 dark:text-blue-400/70 text-lg leading-relaxed mb-6">
                No study groups available yet. Be the first to create one and build an amazing learning community!
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            {groups.map((group, index) => {
              const memberStyling = getMemberCountStyling(group.memberCount || 0);
              return (
                <div
                  key={group._id}
                ...
                >
                  ...
                  <div className="relative p-6 bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-purple-500/10 dark:from-blue-600/20 dark:via-indigo-600/20 dark:to-purple-600/20 border-b border-blue-200/30 dark:border-gray-600/30">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        {/* Status Badge */}
                        <div className={`inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r ${memberStyling.bg} rounded-full shadow-lg ${memberStyling.shadow}`}>
                          <span className="text-lg">{memberStyling.icon}</span>
                          <span className={`font-bold text-sm ${memberStyling.text}`}>
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex items-center gap-4 p-4 bg-blue-50/50 dark:bg-blue-900/20 rounded-xl border border-blue-100/50 dark:border-blue-800/30">
                        ...
                        <div className="flex-1">
                          <span className="font-semibold text-blue-800 dark:text-blue-300 text-sm block">Members</span>
                          <p className="text-gray-600 dark:text-gray-400 text-sm font-medium">{group.memberCount || 0} active learners</p>
                        </div>
                      ...
                      {group.courseDetail && (
                        <div className="flex items-center gap-4 p-4 bg-indigo-50/50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100/50 dark:border-indigo-800/30">
                          ...
                          <div className="flex-1">
                            <span className="font-semibold text-blue-800 dark:text-blue-300 text-sm block">Course Focus</span>
                            <p className="text-gray-600 dark:text-gray-400 text-sm">{group.courseDetail}</p>
                          </div>
                      ...
                      {group.members && group.members.length > 0 && (
                        <div className="p-4 bg-purple-50/50 dark:bg-purple-900/20 rounded-xl border border-purple-100/50 dark:border-purple-800/30">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="font-semibold text-blue-800 dark:text-blue-300 text-sm">Current Members</span>
                          </div>
                    ...
                    >
                      ...
                      {loading ? (
                        ...
                        <>
                          ...
                          <span className="relative z-10">Join Study Group</span>
                        </>
                      )}
                    </button>
                  </div>
                  ...
                  {/* Card Footer Accent */}
                  <div className={`h-2 bg-gradient-to-r ${memberStyling.bg}`}></div>
                </div>
              );
            })}
          </div>
        ...
        <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-32 left-32 w-52 h-52 bg-gradient-to-r from-purple-200/20 to-pink-300/20 dark:from-purple-700/10 dark:to-pink-600/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-2/3 right-1/4 w-32 h-32 bg-gradient-to-r from-indigo-200/20 to-blue-300/20 dark:from-indigo-600/10 dark:to-blue-500/10 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          <div className="absolute top-1/4 left-3/4 w-36 h-36 bg-gradient-to-r from-cyan-200/20 to-teal-300/20 dark:from-cyan-600/10 dark:to-teal-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
          
          {/* Floating particles */}
          <div className="absolute top-1/4 left-1/5 w-3 h-3 bg-blue-400/40 dark:bg-blue-300/30 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
          <div className="absolute top-3/4 right-1/5 w-2 h-2 bg-indigo-400/40 dark:bg-indigo-300/30 rounded-full animate-bounce" style={{ animationDelay: '1.5s' }}></div>
          <div className="absolute bottom-1/4 left-1/2 w-4 h-4 bg-purple-400/40 dark:bg-purple-300/30 rounded-full animate-bounce" style={{ animationDelay: '2.5s' }}></div>
          <div className="absolute top-1/2 right-1/6 w-2 h-2 bg-pink-400/40 dark:bg-pink-300/30 rounded-full animate-bounce" style={{ animationDelay: '3.5s' }}></div>
        </div>
      </div>
    </div>
  );
