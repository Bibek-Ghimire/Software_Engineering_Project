        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="px-8 pb-8">
              ...
              >
                <h2 className="text-3xl font-bold text-stone-900 dark:text-stone-50 mb-4">
                  About This Course
                </h2>
                <p className="text-lg body-copy leading-relaxed whitespace-pre-wrap">
                  {course.description}
                </p>
              </motion.div>
            </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-3">
                    {course.keywords.map((keyword, index) => (
                      <motion.span
                        key={index}
                        className="nav-chip px-4 py-2 rounded-full font-semibold text-sm"
            ...
            {/* Footer CTA */}
            <div className="px-8 py-8 surface-card border-t border-stone-200 dark:border-stone-700">
              <motion.div
              ...
              >
                <p className="body-copy mb-4 text-lg">
                  {isEnrolled
                ...
                {!isEnrolled && (
                  <button
                    ...
                    className="primary-action px-8 py-4 rounded-xl font-bold text-lg"
                  >
