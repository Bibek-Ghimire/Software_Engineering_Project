    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-100">
        <div className="text-center">
          ...
          <p className="text-xl font-semibold text-sky-700 animate-pulse">Loading profile...</p>
        </div>
      </div>
    );
      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-sky-700 dark:text-sky-300">Teaching Information</h2>
            </div>
            
            {isEditing && !viewOnly ? (
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">Subject</label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div>
                  <label className="block text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">Qualification</label>
                  <input
                    type="text"
                    name="qualification"
                ...
                <div>
                  <label className="block text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">Institution</label>
                  <input
                    type="text"
                    name="college"
                ...
                <div>
                  <label className="block text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">Bio</label>
                  <textarea
                    name="bio"
                    value={formData.bio || ""}
                    onChange={handleChange}
              ...
              <div className="space-y-6">
                <InfoCard icon={<BookOpen className="w-4 h-4 text-sky-500" />} label="Subject" value={profile.subject || "Not added yet"} />
                <InfoCard icon={<GraduationCap className="w-4 h-4 text-sky-500" />} label="Qualification" value={profile.qualification || "Not added yet"} />
                <InfoCard icon={<MapPin className="w-4 h-4 text-sky-500" />} label="Institution" value={profile.college || "Not added yet"} />
                <div className="bg-gradient-to-r from-sky-50 to-blue-50 dark:from-gray-700/50 dark:to-gray-600/50 rounded-xl p-6 border-l-4 border-sky-400 shadow-inner">
                  <p className="text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">About</p>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-sky-700 dark:text-sky-300">Achievements</h2>
            </div>
                ...
                {formData.achievements.map((item, index) => (
                  <div key={index} className="flex gap-3 items-center group">
                    <input
                      ...
                      value={item}
                      onChange={(e) =>
                        handleItemChange("achievements", index, e.target.value)
                      }
              ...
              <div className="space-y-3">
                {profile.achievements.length > 0 ? (
                  profile.achievements.map((achievement, index) => (
                    <div key={index} className="flex items-start gap-3 p-4 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl border border-amber-200/50 dark:border-amber-700/50 hover:shadow-md transition-all duration-300">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          {["skills", "interests"].map((field, fieldIndex) => (
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                <div className={`w-10 h-10 bg-gradient-to-r ${field === 'skills' ? 'from-emerald-500 to-teal-600' : 'from-pink-500 to-rose-600'} rounded-xl flex items-center justify-center shadow-md`}>
                  <Star className="w-5 h-5 text-white" />
                </div>
                <h2 className="text-2xl font-bold text-sky-700 dark:text-sky-300 capitalize">{field}</h2>
              </div>
                ...
                <div className="flex flex-wrap gap-3">
                  {profile[field].length > 0 ? (
                    ...
                    <div className="text-center py-8 w-full">
                      <div className={`w-16 h-16 bg-gradient-to-br ${field === 'skills' ? 'from-emerald-200 to-teal-300' : 'from-rose-200 to-pink-300'} rounded-full mx-auto mb-4 flex items-center justify-center`}>
                        <Star className={`w-6 h-6 ${field === 'skills' ? 'text-emerald-600' : 'text-rose-600'}`} />
                      </div>
                      <p className="text-gray-500 dark:text-gray-400">No {field} added yet</p>
                    </div>
                  )}
                </div>
              )}
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-sky-700 dark:text-sky-300">Resume</h2>
            </div>
            ...
            {isEditing && !viewOnly ? (
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 rounded-xl p-6 border border-indigo-200/50 dark:border-indigo-700/50">
                ...
                >
                  ...
                  <span className="group-hover:underline">View / Download Resume</span>
                </a>
              </div>
            ) : (
              <div className="text-center py-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-sky-700 dark:text-sky-300">Connect</h2>
            </div>

            {isEditing && !viewOnly ? (
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">LinkedIn</label>
                  <input
                    type="url"
                    name="linkedin"
                ...
                <div>
                  <label className="block text-sm font-semibold text-sky-600 dark:text-sky-400 mb-2 uppercase tracking-wide">GitHub</label>
                  <input
                    type="url"
                    name="github"
              ...
              <div className="space-y-4">
                {profile.linkedin && (
                  ...
                  >
                    ...
                    <span className="text-blue-600 dark:text-blue-400 font-semibold group-hover:underline">LinkedIn Profile</span>
                  </a>
                )}
                {profile.github && (
                  <a
                  ...
                  >
                    ...
                    <span className="text-gray-700 dark:text-gray-300 font-semibold group-hover:underline">GitHub Profile</span>
                  </a>
                )}
