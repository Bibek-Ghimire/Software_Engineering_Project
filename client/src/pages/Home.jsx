...
import {
  Users, BookOpen, Award, MessageCircle, Globe, Target, Zap, Play, Sun, Moon, 
  ArrowRight, Info, ChevronDown, ChevronUp, Star, TrendingUp, Shield, 
  Clock, Heart, CheckCircle, Quote, Sparkles, Brain, Lightbulb, Trophy,
  FileText, Video, MessageSquare, BarChart3, Rocket, Coffee
} from "lucide-react";
...
const features = [
  {
    ...
    description: "Connects you with compatible study partners based on learning goals, schedules, and academic interests.",
    gradient: "from-blue-500 to-cyan-500"
  },
  {
    icon: <BookOpen className="w-8 h-8" />,
    title: "Collaborative Knowledge Hub",
    description: "Build comprehensive study materials together with real-time editing, version control, and expert-verified content.",
    gradient: "from-purple-500 to-indigo-500"
  },
  {
    icon: <Award className="w-8 h-8" />,
    title: "Entartaining Learning Journey",
    description: "Earn badges, climb leaderboards, and unlock achievements as you progress through your academic milestones.",
    gradient: "from-yellow-500 to-orange-500"
  },
  {
    icon: <MessageCircle className="w-8 h-8" />,
    title: "24/7 Peer Support Network",
    description: "Access instant help through live chat, video calls, and discussion forums moderated by AI and peer mentors.",
    gradient: "from-green-500 to-emerald-500"
  },
  {
    icon: <Brain className="w-8 h-8" />,
    title: "Adaptive Learning Paths",
    description: "Personalized study plans that adapt to your pace, strengths, and areas for improvement using machine learning.",
    gradient: "from-pink-500 to-rose-500"
  },
  {
    icon: <Target className="w-8 h-8" />,
    title: "Goal Tracking & Analytics",
    description: "Monitor your progress with detailed insights, performance metrics, and predictive success indicators.",
...
const stats = [
  ...
  { number: "2.5K+", label: "Study Squads", icon: <Heart className="w-6 h-6" /> },
  { number: "200+", label: "Courses", icon: <BookOpen className="w-6 h-6" /> },
  { number: "99.2%", label: "Success Rate", icon: <TrendingUp className="w-6 h-6" /> }
];
...
const testimonials = [
  {
    ...
    content: "Syncademy transformed my study routine. The collaborative notes feature helped me ace my algorithms course!",
    rating: 5,
    avatar: "👨‍💻"
  },
  {
    ...
    content: "The peer support network is incredible. Having study partners available 24/7 made med school so much more manageable.",
    rating: 5,
    avatar: "👨‍💻"
  },
  {
    ...
    role: "IT Student",
    content: "The peer to peer learning aspect keeps me motivated. I've never been more engaged with my studies than I am now!",
    rating: 5,
    avatar: "👨‍💻"
  }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 text-gray-800 dark:text-gray-200 overflow-x-hidden">
      ...
      <header className="relative">
        ...
        <div className="relative pt-8 px-6 md:px-12 lg:px-20">
          {/* Navigation */}
          <nav className="flex justify-between items-center backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 rounded-2xl p-4 shadow-lg border border-white/20">
            <motion.div 
            ...
            <div className="flex gap-8 items-center">
              <button onClick={() => handleNavigation("/")} className="text-blue-600 hover:text-blue-800 font-medium transition-colors">Home</button>
              <button
              ...
              <button onClick={() => handleNavigation("/login")} className="text-blue-600 hover:text-blue-800 font-medium transition-colors">Login</button>
              <button 
            ...
            >
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-2xl">
                  Transform your learning experience with collaborative study groups, collaborative note-taking, 
                  and a supportive community of learners. Success is better when shared.
                </p>
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute -top-4 -right-4 bg-white dark:bg-gray-800 p-3 rounded-xl shadow-xl border border-blue-100 dark:border-blue-800"
                >
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                    <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">Live Study Session</span>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -left-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-3 rounded-xl shadow-xl"
                >
                  <div className="flex items-center gap-2">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-24">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Syncademy?</span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Experience the future of education with cutting-edge technology designed to maximize your learning potential through collaboration and community.
          </p>
        </motion.div>
        ...
        <div className="px-6 md:px-12 lg:px-20">
          ...
          >
            ...
            <p className="text-blue-100 text-lg max-w-2xl mx-auto">
              Join thousands of students who have transformed their learning experience with Syncademy
            </p>
          </motion.div>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-200 ${
                    i === currentTestimonial ? 'bg-white scale-125' : 'bg-white/50 hover:bg-white/75'
                  }`}
                />
              ))}
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <div className="relative bg-white dark:bg-gray-800 p-2 rounded-3xl shadow-2xl">
              <img src={team} alt="Syncademy Team" className="rounded-2xl w-full" />
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
              <p className="text-lg">
                Syncademy is a next-generation peer learning platform designed to empower students through collaborative 
                study methods and community-driven academic support. We revolutionize traditional learning by creating 
                an interactive environment where knowledge flows freely.
              </p>
              ...
              <AnimatePresence>
                {showMore && (
                  ...
                  >
                    <p>
                      Our mission is to transform education by fostering collaborative learning environments where students 
                      can create study groups, share knowledge, and achieve academic excellence together. Unlike conventional 
                      e-learning tools, Syncademy encourages active participation and real-time collaboration.
                    </p>
                    <p>
                      Whether you're preparing for competitive exams or solidifying academic foundations, Syncademy provides 
                      the digital infrastructure to make learning social, productive, and goal-oriented. Our platform combines 
                      AI technology with proven collaborative methodologies.
                    </p>
                    ...
                    <div className="bg-white dark:bg-gray-800/50 rounded-2xl p-6 border border-blue-100 dark:border-blue-800">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium">Inclusive Learning for All</span>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center">
                            <CheckCircle className="w-4 h-4 text-white" />
                          </div>
                          <span className="font-medium">Community-Driven Growth</span>
                        </div>
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center">
                            <CheckCircle className="w-4 h-4 text-white" />
                          </div>
                          <span className="font-medium">Innovation in Education</span>
                        </div>
                        <div className="flex items-center gap-3">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6">
                      ...
                      <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                        <li className="flex items-center gap-3">
                          ...
                          Foster real-time collaboration and meaningful discussions
                        </li>
                        <li className="flex items-center gap-3">
                        ...
                        <li className="flex items-center gap-3">
                          ...
                          Provide scalable tools for students and educational institutions
                        </li>
                        <li className="flex items-center gap-3">
                          <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
                          Integrate gamification to boost engagement and motivation
                        </li>
                      </ul>
                    </div>
                  </motion.div>
      ...
      <section className="bg-gray-50 dark:bg-gray-800/50 px-6 md:px-12 lg:px-20 py-24">
        ...
        >
          ...
          <h2 className="text-4xl font-bold mb-6">
            <span className="text-gray-800 dark:text-white">Simple Steps to </span>
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Success</span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Get started in minutes and unlock the power of collaborative learning
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: "Sign up in seconds and tell us about your learning goals, subjects, and preferences. Our AI will help match you with compatible study partners based on your academic interests and schedule.",
              icon: <Users className="w-8 h-8" />,
              color: "from-green-500 to-emerald-500",
              features: ["Matching your Interests", "Goal setting", "Schedule sync"]
            },
            {
              step: "02", 
              title: "Join Study Squads",
              description: "Connect with peers who share your academic interests. Collaborate on notes, share resources, participate in live study sessions, and support each other through challenging topics.",
            ...
            },
            {
              ...
              description: "Track your progress with detailed analytics, earn achievement badges, and celebrate milestones. Watch as collaborative learning accelerates your academic success exponentially.",
            ...
            >
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-600 transition-all duration-300 transform hover:-translate-y-2">
                ...
                <div className="pt-8">
                  <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${step.color} rounded-2xl mb-6 text-white shadow-lg`}>
                    {step.icon}
                  </div>
      ...
      <section className="bg-white dark:bg-gray-800 px-6 md:px-12 lg:px-20 py-24">
        ...
        >
          <h2 className="text-4xl font-bold mb-6">
            <span className="text-gray-800 dark:text-white">Powerful Tools for </span>
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Modern Learning</span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: <FileText className="w-6 h-6" />, title: "Smart Notes", desc: "AI-enhanced note-taking", color: "blue" },
            { icon: <Video className="w-6 h-6" />, title: "Live Sessions", desc: "HD video study rooms", color: "green" },
            { icon: <MessageSquare className="w-6 h-6" />, title: "Instant Chat", desc: "Real-time messaging", color: "purple" },
            { icon: <BarChart3 className="w-6 h-6" />, title: "Analytics", desc: "Progress insights", color: "orange" }
          ].map((tool, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, scale: 0.8 }}
            ...
            >
              <div className={`inline-flex items-center justify-center w-12 h-12 bg-${tool.color}-500 rounded-xl mb-3 text-white group-hover:scale-110 transition-transform duration-200`}>
                {tool.icon}
              </div>
              <h4 className="font-semibold text-gray-800 dark:text-white mb-1">{tool.title}</h4>
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Join our community, share feedback, or collaborate with us. We're here to support your learning journey 
            and welcome contributions from passionate educators and developers.
          </p>
        </div>
          ...
          {[
            {
              ...
              description: "Explore our codebase, report issues, submit pull requests, and help us build the future of education together.",
              link: "https://github.com/Bibek-Ghimire",
              linkText: "github.com/Bibek-Ghimire",
              gradient: "from-gray-600 to-gray-800",
              features: ["View source code", "Report bugs", "Submit features", "Join development"]
            },
            {
              icon: linkedin,
              title: "Professional Network",
              subtitle: "Connect & Follow",
              description: "Stay updated with our latest features, join professional discussions, and connect with our team members.",
              link: "https://www.linkedin.com/in/your-profile",
              linkText: "linkedin.com/in/your-profile",
              gradient: "from-blue-600 to-blue-800",
              features: ["Follow updates", "Network with team", "Career opportunities", "Industry insights"]
            },
            {
              icon: email,
              title: "Direct Contact",
              subtitle: "Questions & Partnerships",
              description: "Have specific questions, partnership ideas, or need enterprise solutions? We'd love to hear from you.",
              link: "mailto:bibekghimire764@gmail.com",
              linkText: "bibekghimire764@gmail.com",
              gradient: "from-red-500 to-red-600",
              features: ["General inquiries", "Partnership opportunities", "Enterprise solutions", "Technical support"]
            }
          ].map((contact, index) => (
            <motion.div
              key={index}
              ...
              className="group relative"
            >
              <div className={`absolute inset-0 bg-gradient-to-r ${contact.gradient} rounded-3xl blur opacity-0 group-hover:opacity-10 transition-opacity duration-300`}></div>
              <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-xl border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-600 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                <div className="flex items-center justify-center mb-6">
                  <div className={`w-16 h-16 bg-gradient-to-r ${contact.gradient} rounded-2xl flex items-center justify-center p-3 shadow-lg`}>
                    <img src={contact.icon} alt={contact.title} className="w-10 h-10 filter brightness-0 invert" />
                  </div>
                </div>
                ...
                <p className={`text-sm font-semibold bg-gradient-to-r ${contact.gradient} bg-clip-text text-transparent mb-4 text-center`}>
                  {contact.subtitle}
                </p>
                ...
                <div className="space-y-2 mb-6">
                  {contact.features.map((feature, i) => (
                    <div key={i} className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                      <div className={`w-1.5 h-1.5 bg-gradient-to-r ${contact.gradient} rounded-full`}></div>
                      {feature}
                    </div>
                  ))}
                </div>
        ...
        <div className="relative px-6 md:px-12 lg:px-20 py-24 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
              ...
              Start collaborating, start achieving, start succeeding with Syncademy.
            </p>
            ...
            {/* Trust indicators */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white/80 text-sm max-w-2xl mx-auto">
            ...
            <div className="mt-12 flex items-center justify-center gap-8 text-white/60 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>4.9/5 rating on all platforms</span>
              </div>
              <div className="flex items-center gap-2">
