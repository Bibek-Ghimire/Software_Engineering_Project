...
import { Linkedin, Github, Download, Edit2, Mail, Moon, Sun, MapPin, Star } from "lucide-react";
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-sky-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-xl text-sky-700 dark:text-sky-300">Basic Information</h3>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <InfoItem label="Full Name" value={user.name} />
                <InfoItem label="Email" value={user.email} icon={<Mail className="w-4 h-4 text-sky-500" />} />
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-sky-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-xl text-sky-700 dark:text-sky-300">Bio</h3>
              </div>
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-sky-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-xl text-sky-700 dark:text-sky-300">Skills</h3>
              </div>
            ...
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-sky-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-xl text-sky-700 dark:text-sky-300">Interests</h3>
              </div>
              <div className="flex flex-wrap gap-3">
            ...
            {user.resume && (
              <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-sky-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-bold text-xl text-sky-700 dark:text-sky-300">Resume</h3>
                </div>
          ...
          <div className="space-y-8">
            <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-sky-100/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-xl text-sky-700 dark:text-sky-300">Links & Contact</h3>
              </div>
              <div className="space-y-4">
                {user.linkedin && (
                  ...
                  >
                    ...
                    <span className="text-blue-600 dark:text-blue-400 font-semibold group-hover:underline">LinkedIn</span>
                  </a>
                )}
                {user.github && (
                  <a
                  ...
                  >
                    ...
                    <span className="text-gray-700 dark:text-gray-300 font-semibold group-hover:underline">GitHub</span>
                  </a>
                )}
              </div>
            </div>
